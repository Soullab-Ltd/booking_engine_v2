...
import { EventData, Plan, FoodPreference, Guest, PlanIcon } from './types';

const createPlanIcons = (planID: number, titles: string[]): PlanIcon[] =>
  titles.map((title, index) => ({
    id: Number(`${planID}${index + 1}`),
    title,
    iconUrl: '',
    type: 'text',
    planID,
...
export const MOCK_PLANS: Plan[] = [
  {
    ...
    PlanTitle: "Plan A: PVI Dorms",
    PlanName: "Plan A: PVI Dorms",
    thumbnail: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=800&auto=format&fit=crop",
    banner: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=800&auto=format&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=800&auto=format&fit=crop",
    description: "4 Days and 3 Nights - Dorm Accommodation (1 bed per person).",
    PlanDescription: "4 Days and 3 Nights - Dorm Accommodation (1 bed per person).",
    ...
    amenities: createPlanIcons(101, ["1 Bunk bed (1 Guest)", "192 sqft Space", "Common Bathroom", "Hot water (Fixed time)", "Meals at Pyramid Valley International", "Free WiFi in Public Area", "Parking Available"]),
    images: [],
  },
  {
    planID: 102,
    ...
    PlanTitle: "Plan B: Deluxe Rooms",
    PlanName: "Plan B: Deluxe Rooms",
    thumbnail: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop",
    banner: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&auto=format&fit=crop",
    description: "4 Days and 3 Nights - 1 Bed for 2 Guests with attached bath.",
    PlanDescription: "4 Days and 3 Nights - 1 Bed for 2 Guests with attached bath.",
    ...
    finalPrice: 19000,
    gstDetails: "Inclusive of GST",
    amenities: createPlanIcons(102, ["1 Bed (2 Guests)", "Attached Bathroom", "192 sqft Space", "Daily Housekeeping", "Morning Hot Water", "Meals at Pyramid Valley International", "Free WiFi in Public Area", "Parking Available"]),
    images: [],
  },
  {
    planID: 103,
    ...
    PlanTitle: "Plan C: Premium Triple",
    PlanName: "Plan C: Premium Triple",
    thumbnail: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&auto=format&fit=crop",
    banner: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&auto=format&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&auto=format&fit=crop",
    description: "4 Days and 3 Nights - Premium Triple Occupancy at Pyramid Valley International.",
    PlanDescription: "4 Days and 3 Nights - Premium Triple Occupancy at Pyramid Valley International.",
    ...
    finalPrice: 21000,
    gstDetails: "Inclusive of GST",
    amenities: createPlanIcons(103, ["3 Single Beds", "Premium Bathroom Essentials", "Elevator Access", "24hr Hot/Cold Water", "Meals at Pyramid Valley International", "Free WiFi in Room", "Swimming Pool Access"]),
    images: [],
  },
  {
    planID: 104,
    ...
    PlanTitle: "Plan D: Premium Double",
    PlanName: "Plan D: Premium Double",
    thumbnail: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=800&auto=format&fit=crop",
    banner: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=800&auto=format&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?w=800&auto=format&fit=crop",
    description: "4 Days and 3 Nights - King Size Bed for 2 Guests.",
    PlanDescription: "4 Days and 3 Nights - King Size Bed for 2 Guests.",
    ...
    finalPrice: 40000,
    gstDetails: "Inclusive of GST",
    amenities: createPlanIcons(104, ["King Size Bed", "Premium Bathroom Essentials", "Elevator Access", "Tea/Coffee Maker", "Meals at Pyramid Valley International", "In-room High-speed WiFi", "Swimming Pool Access"]),
    images: [],
  },
  {
    planID: 105,
    ...
    PlanTitle: "Plan E: Premium Single",
    PlanName: "Plan E: Premium Single",
    thumbnail: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800&auto=format&fit=crop",
    banner: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800&auto=format&fit=crop",
    bannerImage: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800&auto=format&fit=crop",
    description: "4 Days and 3 Nights - Private King Size Bed for 1 Guest.",
    PlanDescription: "4 Days and 3 Nights - Private King Size Bed for 1 Guest.",
    ...
    finalPrice: 40000,
    gstDetails: "Inclusive of GST",
    amenities: createPlanIcons(105, ["Private King Bed", "Solitary Premium Stay", "Elevator Access", "Tea/Coffee Maker", "Meals at Pyramid Valley International", "In-room High-speed WiFi", "Swimming Pool Access"]),
    images: [],
  }
];
