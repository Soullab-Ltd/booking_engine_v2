        ...
        {plans.map((plan: any, index: number) => {
          ...
          return (
            <div
              ...
              className="relative w-full max-w-2xl mx-auto bg-white rounded-3xl shadow-md border border-stone-100 flex flex-col md:flex-row hover:shadow-2xl transition-all duration-500 group"
            >
              {soldOut ? (
