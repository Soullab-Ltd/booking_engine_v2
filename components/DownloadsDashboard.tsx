...
const DownloadsDashboard: React.FC<DownloadsDashboardProps> = ({
  ...
  const downloadsUi = dashboardUi?.downloads || {};
  const logisticsUi = dashboardUi?.logistics || {};
  ...
  const documents = [
    ...
    },
    {
      ...
      status: "Ready",
      size: "5.2 MB",
      desc: "Full retreat guide & protocols",
    },
    {
      title: "Stay/Room Details",
      icon: Bed,
      status: "Ready",
      size: "640 KB",
      desc: "Cottage allocation & amenities",
    },
    {
      ...
      status: "Ready",
      size: "3.1 MB",
      desc: "Coordinates for Silent Valley",
    },
    {
      ...
      status: "Ready",
      size: "1.1 MB",
      desc: "Essential items for the 5-day stay",
    },
  ];
    ...
    <div className="max-w-6xl mx-auto px-4 py-16 w-full animate-fadeIn pb-32">
      <div className="mb-12">
        <h2 className="text-5xl font-black text-stone-900 mb-3 tracking-tighter">
          {dashboardUi.title || "Your Downloads"}
        </h2>
        <p className="text-stone-500 font-medium text-lg max-w-2xl leading-relaxed">
          {dashboardUi.desc || "Access all your booking documents and essentials here."}{" "}
          <a
            href="mailto:support@retreat.co"
            className="text-teal-700 underline font-bold underline-offset-4 decoration-teal-700/30 hover:decoration-teal-700 transition-all"
          >
            [Contact Support]
          </a>
        </p>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                    ...
                    <span className="flex items-center gap-2 text-stone-400 font-bold text-xs uppercase tracking-tight">
                      <MapPin className="w-4 h-4 text-teal-600" /> {event?.venue || ""}
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10 pt-10 border-t border-stone-50">
                <div>
                  ...
                  <span className="text-xl font-black text-stone-900 flex items-center gap-2">
                    {guests.length} <span className="text-[10px] text-stone-400 font-bold">Guests</span>
                  </span>
                </div>
          ...
          <section>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
              <h3 className="text-2xl font-black text-stone-900 flex items-center gap-3">
                <Download className="w-7 h-7 text-teal-600" /> {downloadsUi.title || "Downloads"}
              </h3>
              ...
              <button className="w-full sm:w-auto bg-stone-900 text-white px-8 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-black transition-all flex items-center justify-center gap-3 shadow-lg group">
                ...
                {downloadsUi.cta || "Share Documents"}
              </button>
            </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-stone-900 rounded-[40px] p-10 text-white relative overflow-hidden shadow-2xl shadow-stone-200">
            ...
            <h4 className="text-xl font-black mb-8 flex items-center gap-3">
              <Compass className="w-6 h-6 text-teal-400" /> {logisticsUi.title || "Logistics"}
            </h4>
            ...
            <button className="w-full mt-12 bg-white text-stone-900 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-teal-50 transition-all shadow-xl active:scale-95">
              {logisticsUi.cta || "Open Directions"} <Navigation className="w-4 h-4" />
            </button>
          </div>
